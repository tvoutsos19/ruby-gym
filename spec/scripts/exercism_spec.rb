describe "1_two_fer.rb" do
  it "prints 'One for Alice, one for me!' if the user enters 'alice'", points: 1 do
    ...
    expect { require_relative '../../1_two_fer' }.to output(/One for Alice, one for me/).to_stdout
  end
end
...
describe "1_two_fer.rb" do
  it "prints 'One for Shreya, one for me!' if the user enters 'shreya'", points: 1 do
    ...
    expect { require_relative '../../1_two_fer' }.to output(/One for Shreya, one for me/).to_stdout
  end
end
...
describe "1_two_fer.rb" do
  it "prints 'One for you, one for me!' if the user enters nothing", points: 1 do
    ...
    expect { require_relative '../../1_two_fer' }.to output(/One for you, one for me/).to_stdout
  end
end
...
describe "4_raindrops.rb" do
  it "should print 'PlingPlang' when the input is '15'", points: 1 do
    ...
    expect{ require_relative "../../4_raindrops.rb" }.to output(/PlingPlang/).to_stdout
  end
end

describe "5_isogram.rb" do
  it "String#isogram?('angola') should return false", points: 1 do
    # Un-require raindrops.rb
    raindrops = $".select{|r| r.include? '5_isogram.rb'}
    $".delete(raindrops.first)
    # allow_any_instance_of(Object).to receive(:gets).and_return("angola\n")
    
    require_relative "../../5_isogram.rb"
